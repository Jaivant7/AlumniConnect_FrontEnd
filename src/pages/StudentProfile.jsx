...
const StudentProfile = () => {
    ...
    if (loading) return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20">
    ...
    // Section card wrapper component for consistency
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20 body-font pb-16">
                    ...
                    <div className={`h-36 sm:h-44 md:h-52 w-full relative overflow-hidden rounded-t-3xl ${!profile.coverPicture ? 'bg-gradient-to-r from-blue-600 via-indigo-500 to-violet-600' : ''}`}>
                        {profile.coverPicture ? (
                            ...
                            <>
                                ...
                                <div className="absolute -bottom-16 -left-16 w-64 h-64 bg-indigo-400/20 rounded-full blur-3xl"></div>
                    ...
                    <div className="relative bg-white rounded-b-3xl rounded-t-none shadow-lg border border-gray-100 border-t-0 px-6 sm:px-8 pb-6 pt-0" style={{ animation: 'slideUp 0.4s ease-out 0.1s both' }}>
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-end gap-5">
                                <div className="relative -mt-16 sm:-mt-20 shrink-0 self-center sm:self-auto">
                                    ...
                                    {isOwnProfile && (
                                        <label className="absolute bottom-1 right-1 w-10 h-10 bg-blue-600 text-white rounded-full flex items-center justify-center cursor-pointer shadow-lg hover:bg-blue-700 transition-colors border-[3px] border-white">
                                ...
                                <div className="flex-1 min-w-0 pb-1 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 text-center sm:text-left">
                                    <div>
                                        ...
                                        <p className="text-gray-500 mt-0.5 text-sm font-medium">
                                            {profile.department || 'Department'} • Class of {new Date().getFullYear() + (4 - (profile.year || 0))}
                                        </p>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3 justify-center sm:justify-end flex-shrink-0">
                                        {isOwnProfile ? (
                                            <button
                                                ...
                                                className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-5 py-2.5 rounded-full font-semibold transition-all flex items-center gap-2 shadow-md shadow-blue-600/20 hover:shadow-lg hover:shadow-blue-600/30 text-sm"
                                            >
                                                <Edit3 className="w-4 h-4" />
                                            ...
                                            <button
                                                onClick={handleChat}
                                                className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-6 py-2.5 rounded-full font-semibold transition-all shadow-md shadow-blue-600/20 hover:shadow-lg flex items-center gap-2 text-sm"
                                            >
                                        ...
                                        <div className="flex -space-x-1.5">
                                            {profile.connections && profile.connections.length > 0 ? (
                                                profile.connections.slice(0, 3).map((conn) => (
                                                    <div key={conn._id} title={conn.name} className="w-6 h-6 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-full border-2 border-white flex items-center justify-center text-white text-[9px] font-bold">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                ...
                                <div className="lg:col-span-2 space-y-6">
                                    ...
                                    <SectionCard delay="0.15s">
                                        <SectionHeader icon={User} iconBg="bg-blue-50" iconColor="text-blue-600" title="About" />
                                    ...
                                    <SectionCard delay="0.2s">
                                        <SectionHeader icon={Code} iconBg="bg-emerald-50" iconColor="text-emerald-600" title="Skills" />
                                        <div className="flex flex-wrap gap-2">
                                            {profile.skills && profile.skills.length > 0 ? (
                                                profile.skills.map((skill, idx) => (
                                                    <span key={idx} className="px-3.5 py-1.5 bg-gradient-to-r from-slate-50 to-gray-50 text-gray-700 rounded-lg text-sm font-medium border border-gray-200/80 hover:border-blue-200 hover:bg-blue-50/50 hover:text-blue-700 transition-all cursor-default">
                                                        {skill}
                                                    </span>
                                                ))
                                            ) : (
                                        ...
                                        <div className="space-y-3">
                                            {profile.projects && profile.projects.length > 0 ? (
                                                profile.projects.map((project, idx) => (
                                                    <div key={idx} className="group p-4 bg-gradient-to-r from-gray-50/80 to-slate-50/50 rounded-xl border border-gray-100 hover:border-blue-200/60 hover:shadow-sm transition-all">
                                                        <div className="flex items-start justify-between">
                                                            ...
                                                            <ChevronRight className="w-4 h-4 text-gray-300 group-hover:text-blue-400 transition-colors mt-1 shrink-0 ml-3" />
                                                        </div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    {profile.role === 'student' && (
                                        <SectionCard delay="0.2s">
                                            <SectionHeader icon={GraduationCap} iconBg="bg-indigo-50" iconColor="text-indigo-600" title="Academics" />
                                            <div className="space-y-4">
                                                ...
                                                {profile.lookingFor && (
                                                    <div className="pt-2">
                                                        <span className="text-xs text-gray-500 font-medium block mb-2">Looking For</span>
                                                        <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-700 rounded-lg text-sm font-semibold border border-blue-100">
                                    ...
                                    {/* Applied Jobs */}
                                    {isOwnProfile && profile.appliedJobs && profile.appliedJobs.length > 0 && (
                                        <SectionCard delay="0.3s">
                                            ...
                                            <div className="space-y-2">
                                                {profile.appliedJobs.map((job) => (
                                                    <div key={job._id || job} className="p-3 bg-gray-50/80 rounded-xl border border-gray-100 hover:bg-gray-50 transition-colors">
                                                        <h4 className="font-semibold text-gray-900 text-sm">{job.title || 'Job Posting'}</h4>
                                                        <p className="text-xs text-gray-500 mt-0.5">{job.company || 'Unknown Company'}</p>
                                                    </div>
                                                ))}
                                            </div>
                                        </SectionCard>
                            ...
                            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 animate-fade-in">
                                ...
                                <form onSubmit={handleSave} className="space-y-8">
                                    ...
                                    <div className="bg-gray-50/50 p-6 rounded-2xl border border-gray-100">
                                        <h3 className="text-base font-bold text-gray-900 mb-4 flex items-center gap-2"><User className="w-5 h-5 text-blue-600" /> General Information</h3>
                                    ...
                                    {/* Social Links */}
                                    <div className="bg-gray-50/50 p-6 rounded-2xl border border-gray-100">
                                        <h3 className="text-base font-bold text-gray-900 mb-4 flex items-center gap-2"><Globe className="w-5 h-5 text-blue-600" /> Social Links</h3>
                                    ...
                                    {profile.role === 'student' && (
                                        <div className="bg-gray-50/50 p-6 rounded-2xl border border-gray-100">
                                            <h3 className="text-base font-bold text-gray-900 mb-4 flex items-center gap-2"><GraduationCap className="w-5 h-5 text-blue-600" /> Academic Details</h3>
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                <div>
                                                    <label className="block text-sm font-semibold text-gray-700 mb-1.5">Department</label>
                                                    <input type="text" className="input-field bg-white" value={formData.department} onChange={e => setFormData({ ...formData, department: e.target.value })} />
                                                </div>
                                                <div>
                                                    <label className="block text-sm font-semibold text-gray-700 mb-1.5">Year (1-4)</label>
                                                    <input type="number" min="1" max="4" className="input-field bg-white" value={formData.year} onChange={e => setFormData({ ...formData, year: e.target.value })} />
                                                </div>
                                                <div>
                                                    <label className="block text-sm font-semibold text-gray-700 mb-1.5">CGPA</label>
                                                    <input type="text" className="input-field bg-white" value={formData.cgpa} onChange={e => setFormData({ ...formData, cgpa: e.target.value })} />
                                                </div>
                                                <div>
                                                    <label className="block text-sm font-semibold text-gray-700 mb-1.5">Looking For</label>
                                                    <select className="input-field bg-white border-gray-300" value={formData.lookingFor} onChange={e => setFormData({ ...formData, lookingFor: e.target.value })}>
                                                ...
                                                <div className="md:col-span-2">
                                                    <label className="block text-sm font-semibold text-gray-700 mb-1.5">Career Interests (comma separated)</label>
                                                    <input type="text" className="input-field bg-white" value={formData.careerInterests} onChange={e => setFormData({ ...formData, careerInterests: e.target.value })} />
                                                </div>
                                            </div>
                                        </div>
                                    )}
                                    ...
                                    <div className="bg-gray-50/50 p-6 rounded-2xl border border-gray-100">
                                        <div className="flex items-center justify-between mb-4">
                                            <h3 className="text-base font-bold text-gray-900 flex items-center gap-2"><Briefcase className="w-5 h-5 text-blue-600" /> Projects</h3>
                                            <button type="button" onClick={handleAddProject} className="text-sm font-semibold text-blue-600 hover:text-blue-700 bg-blue-50 px-3 py-1.5 rounded-lg hover:bg-blue-100 transition-colors">
                                                + Add Project
                                            </button>
                                        </div>
                                        <div className="space-y-4">
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex items-center gap-3">
                                                <div className="relative inline-block w-12 mr-2 align-middle select-none">
                                                    <input type="checkbox" id="hideEmail" checked={formData.privacy.hideEmail} onChange={e => setFormData({ ...formData, privacy: { ...formData.privacy, hideEmail: e.target.checked } })} className="checked:bg-blue-600 outline-none focus:outline-none right-4 checked:right-0 duration-200 ease-in absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer" />
                                            ...
                                            <div className="flex items-center gap-3">
                                                <div className="relative inline-block w-12 mr-2 align-middle select-none">
                                                    <input type="checkbox" id="hidePhone" checked={formData.privacy.hidePhone} onChange={e => setFormData({ ...formData, privacy: { ...formData.privacy, hidePhone: e.target.checked } })} className="checked:bg-blue-600 outline-none focus:outline-none right-4 checked:right-0 duration-200 ease-in absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer" />
                                    ...
                                    <div className="flex justify-end gap-3 pt-4">
                                        ...
                                        <button type="submit" className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-8 py-2.5 rounded-xl font-semibold shadow-md shadow-blue-600/20 hover:shadow-lg transition-all">
                                            Save Changes
                                        </button>
                                    </div>
                                </form>
